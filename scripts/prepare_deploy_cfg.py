...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        ...
        sys.exit(1)
    if not os.path.isfile(sys.argv[2]) and "KBASE_ENDPOINT" not in os.environ:
        print("Neither " + sys.argv[2] + " file nor KBASE_ENDPOINT env-variable found.")
        print("Cannot generate new deploy config.")
        sys.exit(1)
