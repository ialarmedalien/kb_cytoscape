...
client_package_name: installed_clients::WorkspaceClient
server_package_name: ${server_package_name}
enable_client_retry: ${enable_client_retry}
display: org.apache.commons.lang.StringUtils@6ce139a4
async_version: ${async_version}
...
=cut
 ...
 sub create_workspace {
    ...
    $self->_validate_params( 'create_workspace', 1, $args_specs, \@args );
...
=cut
 ...
 sub alter_workspace_metadata {
    ...
    $self->_validate_params( 'alter_workspace_metadata', 1, $args_specs, \@args );
...
=cut
 ...
 sub clone_workspace {
    ...
    $self->_validate_params( 'clone_workspace', 1, $args_specs, \@args );
 ...
 sub lock_workspace {
    ...
    my $args_specs = [
        {   index       => 1,
            name        => 'wsi',
            value       => $wsi,
            validator   => sub { ref($wsi) eq 'HASH' },
            baretype    => 'struct',
        },
    ];
    $self->_validate_params( 'lock_workspace', 1, $args_specs, \@args );
...
=cut
 ...
 sub get_workspacemeta {
    ...
    $self->_validate_params( 'get_workspacemeta', 1, $args_specs, \@args );
...
=cut
 ...
 sub get_workspace_info {
    ...
    $self->_validate_params( 'get_workspace_info', 1, $args_specs, \@args );
...
=cut
 ...
 sub get_workspace_description {
    ...
    $self->_validate_params( 'get_workspace_description', 1, $args_specs, \@args );
...
=cut
 ...
 sub set_permissions {
    ...
    $self->_validate_params( 'set_permissions', 1, $args_specs, \@args );
...
=cut
 ...
 sub set_global_permission {
    ...
    $self->_validate_params( 'set_global_permission', 1, $args_specs, \@args );
...
=cut
 ...
 sub set_workspace_description {
    ...
    $self->_validate_params( 'set_workspace_description', 1, $args_specs, \@args );
 ...
 sub get_permissions_mass {
    ...
    my $args_specs = [
        {   index       => 1,
            name        => 'mass',
            value       => $mass,
            validator   => sub { ref($mass) eq 'HASH' },
            baretype    => 'struct',
        },
    ];
    $self->_validate_params( 'get_permissions_mass', 1, $args_specs, \@args );
...
=cut
 ...
 sub get_permissions {
    ...
    $self->_validate_params( 'get_permissions', 1, $args_specs, \@args );
...
=cut
 ...
 sub save_object {
    ...
    $self->_validate_params( 'save_object', 1, $args_specs, \@args );
...
=cut
 ...
 sub save_objects {
    ...
    $self->_validate_params( 'save_objects', 1, $args_specs, \@args );
...
=cut
 ...
 sub get_object {
    ...
    $self->_validate_params( 'get_object', 1, $args_specs, \@args );
 ...
 sub get_object_provenance {
    ...
    my $args_specs = [
        {   index       => 1,
            name        => 'object_ids',
            value       => $object_ids,
            validator   => sub { ref($object_ids) eq 'ARRAY' },
            baretype    => 'list',
        },
    ];
    $self->_validate_params( 'get_object_provenance', 1, $args_specs, \@args );
...
=cut
 ...
 sub get_objects {
    ...
    $self->_validate_params( 'get_objects', 1, $args_specs, \@args );
...
=cut
 ...
 sub get_objects2 {
    ...
    $self->_validate_params( 'get_objects2', 1, $args_specs, \@args );
...
=cut
 ...
 sub get_object_subset {
    ...
    my $args_specs = [
        {   index       => 1,
            name        => 'sub_object_ids',
            value       => $sub_object_ids,
            validator   => sub { ref($sub_object_ids) eq 'ARRAY' },
            baretype    => 'list',
        },
    ];
    $self->_validate_params( 'get_object_subset', 1, $args_specs, \@args );
 ...
 sub get_object_history {
    ...
    my $args_specs = [
        {   index       => 1,
            name        => 'object',
            value       => $object,
            validator   => sub { ref($object) eq 'HASH' },
            baretype    => 'struct',
        },
    ];
    $self->_validate_params( 'get_object_history', 1, $args_specs, \@args );
...
=cut
 ...
 sub list_referencing_objects {
    ...
    $self->_validate_params( 'list_referencing_objects', 1, $args_specs, \@args );
...
=cut
 ...
 sub list_referencing_object_counts {
    ...
    $self->_validate_params( 'list_referencing_object_counts', 1, $args_specs, \@args );
 ...
 sub get_referenced_objects {
    ...
    my $args_specs = [
        {   index       => 1,
            name        => 'ref_chains',
            value       => $ref_chains,
            validator   => sub { ref($ref_chains) eq 'ARRAY' },
            baretype    => 'list',
        },
    ];
    $self->_validate_params( 'get_referenced_objects', 1, $args_specs, \@args );
...
=cut
 ...
 sub list_workspaces {
    ...
    $self->_validate_params( 'list_workspaces', 1, $args_specs, \@args );
...
=cut
 ...
 sub list_workspace_info {
    ...
    $self->_validate_params( 'list_workspace_info', 1, $args_specs, \@args );
...
=cut
 ...
 sub list_workspace_ids {
    ...
    $self->_validate_params( 'list_workspace_ids', 1, $args_specs, \@args );
...
=cut
 ...
 sub list_workspace_objects {
    ...
    $self->_validate_params( 'list_workspace_objects', 1, $args_specs, \@args );
...
=cut
 ...
 sub list_objects {
    ...
    $self->_validate_params( 'list_objects', 1, $args_specs, \@args );
...
=cut
 ...
 sub get_objectmeta {
    ...
    $self->_validate_params( 'get_objectmeta', 1, $args_specs, \@args );
 ...
 sub get_object_info {
    ...
    my $args_specs = [
        ...
        {   index       => 2,
            ...
            validator   => sub { !ref($includeMetadata) },
            baretype    => 'int',
        },
    ];
    $self->_validate_params( 'get_object_info', 2, $args_specs, \@args );
...
=cut
 ...
 sub get_object_info_new {
    ...
    $self->_validate_params( 'get_object_info_new', 1, $args_specs, \@args );
...
=cut
 ...
 sub get_object_info3 {
    ...
    $self->_validate_params( 'get_object_info3', 1, $args_specs, \@args );
...
=cut
 ...
 sub rename_workspace {
    ...
    $self->_validate_params( 'rename_workspace', 1, $args_specs, \@args );
...
=cut
 ...
 sub rename_object {
    ...
    $self->_validate_params( 'rename_object', 1, $args_specs, \@args );
...
=cut
 ...
 sub copy_object {
    ...
    $self->_validate_params( 'copy_object', 1, $args_specs, \@args );
...
=cut
 ...
 sub revert_object {
    ...
    $self->_validate_params( 'revert_object', 1, $args_specs, \@args );
...
=cut
 ...
 sub get_names_by_prefix {
    ...
    $self->_validate_params( 'get_names_by_prefix', 1, $args_specs, \@args );
...
=cut
 ...
 sub hide_objects {
    ...
    $self->_validate_params( 'hide_objects', 1, $args_specs, \@args );
...
=cut
 ...
 sub unhide_objects {
    ...
    $self->_validate_params( 'unhide_objects', 1, $args_specs, \@args );
...
=cut
 ...
 sub delete_objects {
    ...
    $self->_validate_params( 'delete_objects', 1, $args_specs, \@args );
...
=cut
 ...
 sub undelete_objects {
    ...
    $self->_validate_params( 'undelete_objects', 1, $args_specs, \@args );
...
=cut
 ...
 sub delete_workspace {
    ...
    $self->_validate_params( 'delete_workspace', 1, $args_specs, \@args );
 ...
 sub request_module_ownership {
    ...
    my $args_specs = [
        {   index       => 1,
            name        => 'mod',
            value       => $mod,
            validator   => sub { !ref($mod) },
            baretype    => 'string',
        },
    ];
    $self->_validate_params( 'request_module_ownership', 1, $args_specs, \@args );
...
=cut
 ...
 sub register_typespec {
    ...
    $self->_validate_params( 'register_typespec', 1, $args_specs, \@args );
...
=cut
 ...
 sub register_typespec_copy {
    ...
    $self->_validate_params( 'register_typespec_copy', 1, $args_specs, \@args );
...
=cut
 ...
 sub release_module {
    ...
    $self->_validate_params( 'release_module', 1, $args_specs, \@args );
...
=cut
 ...
 sub list_modules {
    ...
    $self->_validate_params( 'list_modules', 1, $args_specs, \@args );
...
=cut
 ...
 sub list_module_versions {
    ...
    $self->_validate_params( 'list_module_versions', 1, $args_specs, \@args );
...
=cut
 ...
 sub get_module_info {
    ...
    $self->_validate_params( 'get_module_info', 1, $args_specs, \@args );
 ...
 sub get_jsonschema {
    ...
    my $args_specs = [
        {   index       => 1,
            name        => 'type',
            value       => $type,
            validator   => sub { !ref($type) },
            baretype    => 'string',
        },
    ];
    $self->_validate_params( 'get_jsonschema', 1, $args_specs, \@args );
 ...
 sub translate_from_MD5_types {
    ...
    my $args_specs = [
        {   index       => 1,
            name        => 'md5_types',
            value       => $md5_types,
            validator   => sub { ref($md5_types) eq 'ARRAY' },
            baretype    => 'list',
        },
    ];
    $self->_validate_params( 'translate_from_MD5_types', 1, $args_specs, \@args );
 ...
 sub translate_to_MD5_types {
    ...
    my $args_specs = [
        {   index       => 1,
            name        => 'sem_types',
            value       => $sem_types,
            validator   => sub { ref($sem_types) eq 'ARRAY' },
            baretype    => 'list',
        },
    ];
    $self->_validate_params( 'translate_to_MD5_types', 1, $args_specs, \@args );
...
=cut
 ...
 sub get_type_info {
    ...
    $self->_validate_params( 'get_type_info', 1, $args_specs, \@args );
...
=cut
 ...
 sub get_all_type_info {
    ...
    $self->_validate_params( 'get_all_type_info', 1, $args_specs, \@args );
 ...
 sub get_func_info {
    ...
    my $args_specs = [
        {   index       => 1,
            name        => 'func',
            value       => $func,
            validator   => sub { !ref($func) },
            baretype    => 'string',
        },
    ];
    $self->_validate_params( 'get_func_info', 1, $args_specs, \@args );
...
=cut
 ...
 sub get_all_func_info {
    ...
    $self->_validate_params( 'get_all_func_info', 1, $args_specs, \@args );
...
=cut
 ...
 sub grant_module_ownership {
    ...
    $self->_validate_params( 'grant_module_ownership', 1, $args_specs, \@args );
...
=cut
 ...
 sub remove_module_ownership {
    ...
    $self->_validate_params( 'remove_module_ownership', 1, $args_specs, \@args );
...
=cut
 ...
 sub list_all_types {
    ...
    $self->_validate_params( 'list_all_types', 1, $args_specs, \@args );
 ...
 sub administer {
    ...
    my $args_specs = [
        {   index       => 1,
            name        => 'command',
            value       => $command,
            validator   => sub { defined $command },
            baretype    => 'UnspecifiedObject',
        },
    ];
    $self->_validate_params( 'administer', 1, $args_specs, \@args );
...
sub _validate_version {
    ...
    if ( $server_major == 0 ) {
        warn "installed_clients::WorkspaceClient version is $server_version. API subject to change.\n";
    }
}
